...
kitchen = Draft.makeRectangle(2000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(8000, top_view_y, 0), FreeCAD.Rotation(0, 0, 0)))
kitchen.ViewObject.LineWidth = 1.5
bedroom1 = Draft.makeRectangle(3000, 3000, placement=FreeCAD.Placement(FreeCAD.Vector(2000, top_view_y + 3000, 0), FreeCAD.Rotation(0, 0, 0)))
bedroom1.ViewObject.LineWidth = 1.5
bedroom2 = Draft.makeRectangle(3000, 3000, placement=FreeCAD.Placement(FreeCAD.Vector(6000, top_view_y + 3000, 0), FreeCAD.Rotation(0, 0, 0)))
bedroom2.ViewObject.LineWidth = 1.5
# Dimensions - MODERN API (FreeCAD 0.21+)
dim3 = Draft.make_linear_dimension(
    FreeCAD.Vector(2000, top_view_y - 500, 0),
    FreeCAD.Vector(6000, top_view_y - 500, 0)
)
dim3.ViewObject.FontSize = 300
dim4 = Draft.make_linear_dimension(
    FreeCAD.Vector(2000 - 500, top_view_y, 0),
    FreeCAD.Vector(2000 - 500, top_view_y + 3000, 0)
)
dim4.ViewObject.FontSize = 300
# === SIDE VIEW (y_offset = 14000) ===
# Profile projection showing depth
side_view_y = 14000
house_profile = Draft.makeRectangle(12000, 6000, placement=FreeCAD.Placement(FreeCAD.Vector(0, side_view_y, 0), FreeCAD.Rotation(0, 0, 0)))
house_profile.ViewObject.LineWidth = 1.5
# Parking area
parking_area = Draft.makeRectangle(2000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(0, side_view_y, 0), FreeCAD.Rotation(0, 0, 0)))
parking_area.ViewObject.LineWidth = 1.5
# Garden area
garden_area = Draft.makeRectangle(4000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(8000, side_view_y, 0), FreeCAD.Rotation(0, 0, 0)))
garden_area.ViewObject.LineWidth = 1.5
# Dimensions - MODERN API (FreeCAD 0.21+)
...
dim6 = Draft.make_linear_dimension(
    FreeCAD.Vector(-500, side_view_y, 0),
    FreeCAD.Vector(-500, side_view_y + 6000, 0)
)
...
title_block = Draft.makeText(["2BHK House", "Scale: 1:100", "Date: 2024-09-16"], point=FreeCAD.Vector(10000, -1000, 0))
