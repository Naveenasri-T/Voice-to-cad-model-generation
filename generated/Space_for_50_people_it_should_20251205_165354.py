...
import Draft
# TEMPLATE_GENERATED
doc = FreeCAD.newDocument("50BHK_House_Blueprint")
...
for i in range(0, 18000, 2000):
    ...
    # LineStyle "Dotted" not supported, using thin line instead
# === TITLE BLOCK ===
title = Draft.make_text(["50BHK House Blueprint", "Scale: 1:100", "Date: 2025-11-30"], placement=FreeCAD.Placement(FreeCAD.Vector(9000, -1200, 0), FreeCAD.Rotation(0, 0, 0)))
