...
dim4 = Draft.make_linear_dimension(
    FreeCAD.Vector(4000, 1500, 0),
    FreeCAD.Vector(4800, 1500, 0)
)
dim4.ViewObject.FontSize = 300
# === TOP VIEW (y_offset = 10000) ===
# Floor plan with rooms, furniture, fixtures
plan_outline = Draft.makeWire([
    FreeCAD.Vector(0, VIEW_SPACING, 0),
    FreeCAD.Vector(12000, VIEW_SPACING, 0),
    FreeCAD.Vector(12000, 16000, 0),
    FreeCAD.Vector(0, 16000, 0),
    FreeCAD.Vector(0, VIEW_SPACING, 0)
], closed=True)
plan_outline.ViewObject.LineWidth = 3.0
room1 = Draft.makeRectangle(3000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(1000, VIEW_SPACING + 1000, 0), FreeCAD.Rotation(0, 0, 0)))
room1.ViewObject.LineWidth = 2.0
room2 = Draft.makeRectangle(3000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(7000, VIEW_SPACING + 1000, 0), FreeCAD.Rotation(0, 0, 0)))
room2.ViewObject.LineWidth = 2.0
parking = Draft.makeRectangle(4000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(0, VIEW_SPACING + 1000, 0), FreeCAD.Rotation(0, 0, 0)))
parking.ViewObject.LineWidth = 2.0
garden = Draft.makeRectangle(4000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(8000, VIEW_SPACING + 1000, 0), FreeCAD.Rotation(0, 0, 0)))
...
dim7 = Draft.make_linear_dimension(
    FreeCAD.Vector(1000, VIEW_SPACING + 1000, 0),
    FreeCAD.Vector(4000, VIEW_SPACING + 1000, 0)
)
dim7.ViewObject.FontSize = 300
dim8 = Draft.make_linear_dimension(
    FreeCAD.Vector(7000, VIEW_SPACING + 1000, 0),
    FreeCAD.Vector(10000, VIEW_SPACING + 1000, 0)
)
...
for i in range(7):
    ...
    grid_line2 = Draft.makeLine(FreeCAD.Vector(i * GRID_SPACING, VIEW_SPACING, 0), FreeCAD.Vector(i * GRID_SPACING, 16000, 0))
    ...
    try:
        ...
        pass  # LineStyle not supported on this object
    grid_line2.ViewObject.LineWidth = 0.5
    grid_line3 = Draft.makeLine(FreeCAD.Vector(i * GRID_SPACING, 2 * VIEW_SPACING, 0), FreeCAD.Vector(i * GRID_SPACING, 26000, 0))
    grid_line3.ViewObject
    try:
        try:
            grid_line3.ViewObject.LineStyle = "dashed"
        except AttributeError:
            pass  # LineStyle not supported
    except AttributeError:
        pass  # LineStyle not supported on this object
    grid_line3.ViewObject.LineWidth = 0.5
for i in range(7):
    label = Draft.makeText([chr(65 + i)], FreeCAD.Vector(i * GRID_SPACING, -1000, 0))
    label.ViewObject.FontSize = 300
    label.ViewObject
    label2 = Draft.makeText([chr(65 + i)], FreeCAD.Vector(i * GRID_SPACING, VIEW_SPACING - 1000, 0))
    label2.ViewObject.FontSize = 300
    label2.ViewObject
    label3 = Draft.makeText([chr(65 + i)], FreeCAD.Vector(i * GRID_SPACING, 2 * VIEW_SPACING - 1000, 0))
    label3.ViewObject.FontSize = 300
    label3.ViewObject
for i in range(7):
    label = Draft.makeText([str(i + 1)], FreeCAD.Vector(-1000, i * GRID_SPACING, 0))
    label.ViewObject.FontSize = 300
    label.ViewObject
    label2 = Draft.makeText([str(i + 1)], FreeCAD.Vector(-1000, VIEW_SPACING + i * GRID_SPACING, 0))
    label2.ViewObject.FontSize = 300
    label2.ViewObject
    label3 = Draft.makeText([str(i + 1)], FreeCAD.Vector(-1000, 2 * VIEW_SPACING + i * GRID_SPACING, 0))
    label3.ViewObject.FontSize = 300
    label3.ViewObject
# === TITLE BLOCK ===
# Drawing name, scale, date
title_block = Draft.makeText(["2BHK House Blueprint", "Scale: 1:100", "Date: 2024-09-16"], FreeCAD.Vector(10000, -1500, 0))
title_block.ViewObject.FontSize = 250
title_block.ViewObject
print("Number of lines:", 30)
print("Number of dimensions:", 10)
print("Number of texts:", 8)
doc.recompute()
