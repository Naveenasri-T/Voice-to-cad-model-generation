...
# Parking gate
parking_gate = Draft.makeLine(FreeCAD.Vector(0, -1000, 0), FreeCAD.Vector(3000, -1000, 0))
...
y_offset = 10000
living_room = Draft.makeRectangle(6000, 4000, placement=FreeCAD.Placement(FreeCAD.Vector(0, y_offset, 0), FreeCAD.Rotation(0, 0, 0)))
living_room.ViewObject.LineWidth = 1.5
kitchen = Draft.makeRectangle(2000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(6000, y_offset, 0), FreeCAD.Rotation(0, 0, 0)))
kitchen.ViewObject.LineWidth = 1.5
bedroom1 = Draft.makeRectangle(3000, 3000, placement=FreeCAD.Placement(FreeCAD.Vector(8000, y_offset, 0), FreeCAD.Rotation(0, 0, 0)))
bedroom1.ViewObject.LineWidth = 1.5
bedroom2 = Draft.makeRectangle(3000, 3000, placement=FreeCAD.Placement(FreeCAD.Vector(11000, y_offset, 0), FreeCAD.Rotation(0, 0, 0)))
bedroom2.ViewObject.LineWidth = 1.5
bathroom = Draft.makeRectangle(1500, 1500, placement=FreeCAD.Placement(FreeCAD.Vector(10000, y_offset + 2000, 0), FreeCAD.Rotation(0, 0, 0)))
bathroom.ViewObject.LineWidth = 1.5
# Dimensions - MODERN API (FreeCAD 0.21+)
dim3 = Draft.make_linear_dimension(
    FreeCAD.Vector(0, y_offset - 500, 0),
    FreeCAD.Vector(12000, y_offset - 500, 0)
)
dim3.ViewObjectdim3.ViewObject.FontSize = 300
dim4 = Draft.make_linear_dimension(
    FreeCAD.Vector(0, y_offset, 0),
    FreeCAD.Vector(0, y_offset + 6000, 0)
)
...
title_block = Draft.makeText(
    ...
    point=FreeCAD.Vector(0, -1500, 0)
)
title_block.ViewObject.FontSize = 300
# Labels
label_living_room = Draft.makeText(
    ["Living Room"],
    point=FreeCAD.Vector(3000, y_offset + 2000, 0)
)
label_living_room.ViewObject.FontSize = 200
label_kitchen = Draft.makeText(
    ["Kitchen"],
    point=FreeCAD.Vector(6500, y_offset + 1000, 0)
)
label_kitchen.ViewObject.FontSize = 200
label_bedroom1 = Draft.makeText(
    ["Bedroom 1"],
    point=FreeCAD.Vector(8500, y_offset + 2000, 0)
)
label_bedroom1.ViewObject.FontSize = 200
label_bedroom2 = Draft.makeText(
    ["Bedroom 2"],
    point=FreeCAD.Vector(11500, y_offset + 2000, 0)
)
label_bedroom2.ViewObject.FontSize = 200
label_bathroom = Draft.makeText(
    ["Bathroom"],
    point=FreeCAD.Vector(10500, y_offset + 2500, 0)
)
label_bathroom.ViewObject.FontSize = 200
doc.recompute()
