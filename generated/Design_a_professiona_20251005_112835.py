...
foundation.Shape = Part.makeBox(12000, 8000, 600)
foundation.Placement.Base = FreeCAD.Vector(-6000, -4000, -600)
...
bed2_wall_1 = doc.addObject("Part::Feature", "Bed2_Wall_1")
...
bed2_wall_2 = doc.addObject("Part::Feature", "Bed2_Wall_2")
bed2_wall_2.Shape = Part.makeBox(200, 3000, 3000)
bed2_wall_2.Placement.Base = FreeCAD.Vector(8000, 3700, 150)
bed2_wall_2.ViewObject.ShapeColor = (0.8, 0.8, 0.7)

bed2_window = doc.addObject("Part::Feature", "Bed2_Window")
bed2_window.Shape = Part.makeBox(1000, 100, 1200)
bed2_window.Placement.Base = FreeCAD.Vector(5600, 3700 - 250, 800)
...
kitchen_window.Shape = Part.makeBox(1000, 100, 1200)
kitchen_window.Placement.Base = FreeCAD.Vector(1250, 5200 - 250, 800)
...
bath1_wall_1 = doc.addObject("Part::Feature", "Bath1_Wall_1")
...
bath1_wall_2 = doc.addObject("Part::Feature", "Bath1_Wall_2")
bath1_wall_2.Shape = Part.makeBox(200, 2000, 3000)
bath1_wall_2.Placement.Base = FreeCAD.Vector(9400, 0, 150)
...
bath2_wall_1 = doc.addObject("Part::Feature", "Bath2_Wall_1")
...
bath2_wall_2 = doc.addObject("Part::Feature", "Bath2_Wall_2")
bath2_wall_2.Shape = Part.makeBox(200, 1800, 3000)
bath2_wall_2.Placement.Base = FreeCAD.Vector(9400, 2200, 150)
bath2_wall_2.ViewObject.ShapeColor = (0.8, 0.8, 0.7)

# Main entrance door
main_door = doc.addObject