...
# Parking entrance
parking_entrance = Draft.makeLine(FreeCAD.Vector(0, 0, 0), FreeCAD.Vector(0, 2000, 0))
parking_entrance.ViewObject.LineWidth = 2.0
...
# Kitchen
kitchen = Draft.makeRectangle(2000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(7000, 11000, 0), FreeCAD.Rotation(0, 0, 0)))
...
# Bathroom
bathroom = Draft.makeRectangle(1500, 1500, placement=FreeCAD.Placement(FreeCAD.Vector(5000, 12000, 0), FreeCAD.Rotation(0, 0, 0)))
...
# Labels
label1 = Draft.makeText(["Living Room"], point=FreeCAD.Vector(2500, 11500, 0))
label1.ViewObject.FontSize = 200
label2 = Draft.makeText(["Kitchen"], point=FreeCAD.Vector(8000, 11500, 0))
label2.ViewObject.FontSize = 200
label3 = Draft.makeText(["Bedroom 1"], point=FreeCAD.Vector(2500, 14500, 0))
label3.ViewObject.FontSize = 200
label4 = Draft.makeText(["Bedroom 2"], point=FreeCAD.Vector(8000, 14500, 0))
label4.ViewObject.FontSize = 200
label5 = Draft.makeText(["Bathroom"], point=FreeCAD.Vector(5500, 12500, 0))
