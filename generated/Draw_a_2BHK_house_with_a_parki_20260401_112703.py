...
title_block = Draft.makeText(["2BHK House Blueprint", "Scale: 1:100", "Date: 2024-09-16"], point=FreeCAD.Vector(10000, 25000, 0))
title_block.ViewObject.FontSize = 200
# Labels for rooms
living_room_label = Draft.makeText(["Living Room"], point=FreeCAD.Vector(2500, 11500, 0))
living_room_label.ViewObject.FontSize = 200
kitchen_label = Draft.makeText(["Kitchen"], point=FreeCAD.Vector(9000, 11500, 0))
kitchen_label.ViewObject.FontSize = 200
bedroom1_label = Draft.makeText(["Bedroom 1"], point=FreeCAD.Vector(2500, 14500, 0))
...
garden_label = Draft.makeText(["Garden"], point=FreeCAD.Vector(7000, 21500, 0))
garden_label.ViewObject.FontSize = 200
doc.recompute()
