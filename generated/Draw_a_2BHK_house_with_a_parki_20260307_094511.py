...
door1 = Draft.makeLine(FreeCAD.Vector(2000, front_y_offset, 0), FreeCAD.Vector(3000, front_y_offset, 0))
door1.ViewObject.LineWidth = 2.0
window1 = Draft.makeRectangle(800, 1200, placement=FreeCAD.Placement(FreeCAD.Vector(4000, front_y_offset + 1000, 0), FreeCAD.Rotation(0, 0, 0)))
window1.ViewObject.LineWidth = 1.5
window2 = Draft.makeRectangle(800, 1200, placement=FreeCAD.Placement(FreeCAD.Vector(8000, front_y_offset + 1000, 0), FreeCAD.Rotation(0, 0, 0)))
window2.ViewObject.LineWidth = 1.5
# Parking gate
parking_gate = Draft.makeLine(FreeCAD.Vector(0, front_y_offset, 0), FreeCAD.Vector(2000, front_y_offset, 0))
...
# Labels
label_door = Draft.makeText(["Main Door"], point=FreeCAD.Vector(2500, front_y_offset - 500, 0))
label_door.ViewObject.FontSize = 200
label_door.ViewObject.TextColor = (0.0, 0.0, 0.0)
label_window = Draft.makeText(["Window"], point=FreeCAD.Vector(4500, front_y_offset + 1500, 0))
label_window.ViewObject.FontSize = 200
label_window.ViewObject.TextColor = (0.0, 0.0, 0.0)
label_parking = Draft.makeText(["Parking"], point=FreeCAD.Vector(1000, front_y_offset - 500, 0))
label_parking.ViewObject.FontSize = 200
label_parking.ViewObject.TextColor = (0.0, 0.0, 0.0)
...
# Garden
garden = Draft.makeRectangle(4000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(0, top_y_offset + 8000, 0), FreeCAD.Rotation(0, 0, 0)))
...
dim4 = Draft.make_linear_dimension(
    FreeCAD.Vector(0, top_y_offset - 500, 0),
    FreeCAD.Vector(0, top_y_offset + 12000 - 500, 0)
)
dim4.ViewObject.FontSize = 300
# Labels
label_living_room = Draft.makeText(["Living Room"], point=FreeCAD.Vector(3000, top_y_offset + 1500, 0))
...
label_bedroom1 = Draft.makeText(["Bedroom 1"], point=FreeCAD.Vector(2500, top_y_offset + 5500, 0))
label_bedroom1.ViewObject.FontSize = 200
label_bedroom1.ViewObject.TextColor = (0.0, 0.0, 0.0)
label_bedroom2 = Draft.makeText(["Bedroom 2"], point=FreeCAD.Vector(6500, top_y_offset + 5500, 0))
label_bedroom2.ViewObject.FontSize = 200
label_bedroom2.ViewObject.TextColor = (0.0, 0.0, 0.0)
label_garden = Draft.makeText(["Garden"], point=FreeCAD.Vector(2000, top_y_offset + 10000, 0))
label_garden.ViewObject.FontSize = 200
label_garden.ViewObject.TextColor = (0.0, 0.0, 0.0)
# === SIDE VIEW (y_offset = 20000) ===
side_y_offset = 20000
# Profile projection showing depth
side_outline = Draft.makeWire([
    FreeCAD.Vector(0, side_y_offset, 0),
    FreeCAD.Vector(12000, side_y_offset, 0),
    FreeCAD.Vector(12000, side_y_offset + 6000, 0),
    FreeCAD.Vector(0, side_y_offset + 6000, 0),
    FreeCAD.Vector(0, side_y_offset, 0)
], closed=True)
...
# Labels
label_side = Draft.makeText(["Side Elevation"], point=FreeCAD.Vector(6000, side_y_offset + 3000, 0))
label_side.ViewObject.FontSize = 200
label_side.ViewObject.TextColor = (0.0, 0.0, 0.0)
# === GRID SYSTEM ===
grid_spacing = 1000
for i in range(0, 13000, grid_spacing):
    grid_line = Draft.makeLine(FreeCAD.Vector(i, front_y_offset, 0), FreeCAD.Vector(i, front_y_offset + 6000, 0))
    ...
    grid_label = Draft.makeText([chr(65 + i//grid_spacing)], point=FreeCAD.Vector(i, front_y_offset - 500, 0))
    grid_label.ViewObject.FontSize = 200
    grid_label.ViewObject.TextColor = (0.0, 0.0, 0.0)
# === TITLE BLOCK ===
title_block = Draft.makeText(["2BHK House Blueprint", "Scale: 1:100", "Date: 2024-09-16"], point=FreeCAD.Vector(10000, front_y_offset + 6500, 0))
