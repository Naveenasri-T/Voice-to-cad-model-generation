...
living_room_rect.ViewObject
living_room_label = Draft.make_text(["Living Room", "20 sqm"], placement=FreeCAD.Placement(FreeCAD.Vector(2666, 8000, 0), FreeCAD.Rotation(0, 0, 0)))
...
master_bedroom_rect.ViewObject
master_bedroom_label = Draft.make_text(["Master Bedroom", "14 sqm"], placement=FreeCAD.Placement(FreeCAD.Vector(2333, 12250, 0), FreeCAD.Rotation(0, 0, 0)))
...
bedroom_2_rect.ViewObject
bedroom_2_label = Draft.make_text(["Bedroom 2", "10.5 sqm"], placement=FreeCAD.Placement(FreeCAD.Vector(7166, 12000, 0), FreeCAD.Rotation(0, 0, 0)))
...
kitchen_rect.ViewObject
kitchen_label = Draft.make_text(["Kitchen", "8.75 sqm"], placement=FreeCAD.Placement(FreeCAD.Vector(8166, 7250, 0), FreeCAD.Rotation(0, 0, 0)))
...
bathroom_1_rect.ViewObject
bathroom_1_label = Draft.make_text(["Bathroom 1", "5 sqm"], placement=FreeCAD.Placement(FreeCAD.Vector(11833, 7000, 0), FreeCAD.Rotation(0, 0, 0)))
...
bathroom_2_rect.ViewObject
bathroom_2_label = Draft.make_text(["Bathroom 2", "3.6 sqm"], placement=FreeCAD.Placement(FreeCAD.Vector(5866, 11400, 0), FreeCAD.Rotation(0, 0, 0)))
...
parking_rect.ViewObject
parking_label = Draft.make_text(["Parking", "12.5 sqm"], placement=FreeCAD.Placement(FreeCAD.Vector(2666, 2250, 0), FreeCAD.Rotation(0, 0, 0)))
