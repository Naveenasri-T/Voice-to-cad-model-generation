...
kitchen = Draft.makeRectangle(3000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(0, 11000, 0), FreeCAD.Rotation(0, 0, 0)))
kitchen.ViewObject.LineWidth = 2.0
living_room = Draft.makeRectangle(4000, 3000, placement=FreeCAD.Placement(FreeCAD.Vector(4000, 11000, 0), FreeCAD.Rotation(0, 0, 0)))
living_room.ViewObject.LineWidth = 2.0
bedroom1 = Draft.makeRectangle(3000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(8000, 11000, 0), FreeCAD.Rotation(0, 0, 0)))
bedroom1.ViewObject.LineWidth = 2.0
bedroom2 = Draft.makeRectangle(3000, 2000, placement=FreeCAD.Placement(FreeCAD.Vector(8000, 14000, 0), FreeCAD.Rotation(0, 0, 0)))
bedroom2.ViewObject.LineWidth = 2.0
# Dimensions - MODERN API (FreeCAD 0.21+)
dim3 = Draft.make_linear_dimension(
    FreeCAD.Vector(0, 10500, 0),
    FreeCAD.Vector(12000, 10500, 0)
)
...
dim5 = Draft.make_linear_dimension(
    FreeCAD.Vector(0, 20500, 0),
    FreeCAD.Vector(12000, 20500, 0)
)
...
# Labels
kitchen_label = Draft.makeText(["Kitchen"], point=FreeCAD.Vector(1500, 11500, 0))
kitchen_label.ViewObject.FontSize = 200
living_room_label = Draft.makeText(["Living Room"], point=FreeCAD.Vector(6000, 11500, 0))
living_room_label.ViewObject.FontSize = 200
bedroom1_label = Draft.makeText(["Bedroom 1"], point=FreeCAD.Vector(9000, 11500, 0))
bedroom1_label.ViewObject.FontSize = 200
bedroom2_label = Draft.makeText(["Bedroom 2"], point=FreeCAD.Vector(9000, 14500, 0))
bedroom2_label.ViewObject.FontSize = 200
doc.recompute()
