...
living_label = Draft.makeText(["Living Room"], point=FreeCAD.Vector(2500, 7500, 0))
...
kitchen_label = Draft.makeText(["Kitchen"], point=FreeCAD.Vector(7800, 7200, 0))
...
bed1_label = Draft.makeText(["Bedroom 1"], point=FreeCAD.Vector(2200, 11000, 0))
...
bed2_label = Draft.makeText(["Bedroom 2"], point=FreeCAD.Vector(7200, 11000, 0))
...
for i in range(0, 13000, 2000):
    ...
    grid_h.ViewObject.LineStyle = "Dotted"
    label = Draft.makeText([chr(65 + i//2000)], point=FreeCAD.Vector(i, -700, 0))
...
for i in range(0, 18000, 2000):
    ...
    grid_v.ViewObject.LineStyle = "Dotted"

# === TITLE BLOCK ===
title = Draft.makeText(["2BHK House Blueprint", "Scale: 1:100", "Date: 2025-11-30"], point=FreeCAD.Vector(9000, -1200, 0))
