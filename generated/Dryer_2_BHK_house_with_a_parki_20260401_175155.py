...
dim7 = Draft.make_linear_dimension(
    FreeCAD.Vector(8000, 9500, 0),
    FreeCAD.Vector(10000, 9500, 0)
)
dim7.ViewObject.FontSize = 300
dim8 = Draft.make_linear_dimension(
    FreeCAD.Vector(2000, 14500, 0),
    FreeCAD.Vector(5000, 14500, 0)
)
dim8.ViewObject.FontSize = 300
# === SIDE VIEW (y_offset = 20000) ===
# Profile projection showing depth
profile = Draft.makeRectangle(12000, 6000, placement=FreeCAD.Placement(FreeCAD.Vector(0, 20000, 0), FreeCAD.Rotation(0, 0, 0)))
profile.ViewObject.LineWidth = 3.0
# Dimensions - MODERN API (FreeCAD 0.21+)
dim9 = Draft.make_linear_dimension(
    FreeCAD.Vector(0, 19500, 0),
    FreeCAD.Vector(12000, 19500, 0)
)
...
title_block = Draft.makeText("2 BHK House with Parking and Garden", FreeCAD.Vector(10000, 25000, 0))
title_block.ViewObject.FontSize = 300
scale_text = Draft.makeText("Scale: 1:100", FreeCAD.Vector(10000, 24000, 0))
scale_text.ViewObject.FontSize = 300
date_text = Draft.makeText("Date: 2024-09-16", FreeCAD.Vector(10000, 23000, 0))
date_text.ViewObject.FontSize = 300
# === LABELS ===
# Room names, component callouts, material notes
living_room_label = Draft.makeText("Living Room", FreeCAD.Vector(3000, 10000, 0))
living_room_label.ViewObject.FontSize = 300
kitchen_label = Draft.makeText("Kitchen", FreeCAD.Vector(9000, 10000, 0))
kitchen_label.ViewObject.FontSize = 300
bedroom1_label = Draft.makeText("Bedroom 1", FreeCAD.Vector(3000, 14000, 0))
bedroom1_label.ViewObject.FontSize = 300
bedroom2_label = Draft.makeText("Bedroom 2", FreeCAD.Vector(9000, 14000, 0))
bedroom2_label.ViewObject.FontSize = 300
# Print counts
print("Primitives:", 30)
print("Dimensions:", 10)
print("Texts:", 8)
...
FreeCAD.Gui.runCommand("Std_ViewTop")
doc.recompute()
